...
/**
 * Reads and validates the ring app configuration form `res/raw/auth_config.json`.
 * Configuration changes are detected by comparing the hash of the last know configuration to
 * the read configuration. When a configuration change is detected, the app state is reset.
